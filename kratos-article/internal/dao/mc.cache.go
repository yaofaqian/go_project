...
func (d *dao) CacheArticle(c context.Context, id int64) (res *model.ArticleContent, err error) {
	key := keyArt(id)
	res = &model.ArticleContent{}
...
func (d *dao) AddCacheArticle(c context.Context, id int64, val *model.ArticleContent) (err error) {
	if val == nil {
		return
	}
	key := keyArt(id)
